        ...
        <CardContent sx={{ p: { xs: 2, sm: 3, md: 4 } }}>
          ...
          >
            <Box>
              ...
              <Chip label="Text" color="error" variant="outlined" size="small" sx={{ mt: 1 }} />
            </Box>
      ...
      >
        <DialogTitle>
          <Stack direction="row" alignItems="center" justifyContent="space-between">
            ...
            <IconButton onClick={() => setShowQuestionSelector(false)}>
              <Close />
            </IconButton>
          </Stack>
        </DialogTitle>
                  ...
                  <ListItemText
                    ...
                    secondary={
                      <Stack direction="row" spacing={2} sx={{ mt: 1 }}>
                        ...
                        <Typography variant="caption">
                          <strong>Time:</strong> {question.timeLimit} min
                        </Typography>
                      </Stack>
                    }
                  />
