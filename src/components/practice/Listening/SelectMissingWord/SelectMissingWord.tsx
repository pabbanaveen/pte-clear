...
import { SelectMissingWordQuestion, TimerState, SelectMissingWordResult, MissingWordOption } from './SelectMissingWordType';
...
const SelectMissingWord: React.FC<SelectMissingWordProps> = () => {
  ...
  const [results, setResults] = useState<SelectMissingWordResult[]>([]);
        ...
        <DialogContent>
          ...
          <Box sx={{ mb: 2, p: 2, bgcolor: '#e8f5e9', borderRadius: 1 }}>
            ...
            <Typography variant="body2" sx={{ mb: 1 }}>
              Missing Word: <strong>{question.missingWordPosition}</strong>
            </Typography>
            <Typography variant="body2">
